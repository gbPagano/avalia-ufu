...
from auth.crypto import decrypt, symmetric_decrypt
from auth.email_sender import send_confirmation_email
from auth.token import SECRET_KEY, manager    
from auth.exceptions import InvalidCredentialsException, ExpiredTokenException

import crud, schemas, main
...
def confirm_account(token: str, tgt: str, db: Session = Depends(main.get_db)):
